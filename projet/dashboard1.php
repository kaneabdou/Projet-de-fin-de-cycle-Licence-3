    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
          ...
          <li><a href="events.php"><i class="fa fa-font"></i> Reservation salle</a></li>
    ...
    <div id="page-wrapper">
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <form method="POST" class="form" action="enregistrementLgi1.php" enctype="multipart/form-data">
                          ...
                          <?php
                            ...
                            for ($i=0; $i < count($arrayHour); $i++) {
                              ...
                              for ($j=0; $j < count($arrayDay); $j++) {
                                  $reqEmploi = $bdd->prepare("SELECT * FROM emploitemps WHERE idJour=:idJour AND heure=:heure AND idCour != 0");
                                  $reqEmploi->execute(array(":idJour"=>$j+1,":heure"=>$arrayHour[$i]));
                                  $dataEmploi = $reqEmploi->fetch(PDO::FETCH_ASSOC);
                                  $tds .= (!($dataEmploi==false)?"<td>X</td>":"<td><input class='form-control' type='checkbox' name='$arrayDay[$j]$i'/></td>");
                              }
